        ...
        try:
            ...
            # last case -- we have an update to existing arguments.
                ...
                if isinstance(delta_text, str):
                    delta_text = current_text[current_text.rfind(self.streamed_args_for_tool[self.current_tool_id])+len(self.streamed_args_for_tool[self.current_tool_id]):current_text.rfind(delta_text)+len(delta_text)]
